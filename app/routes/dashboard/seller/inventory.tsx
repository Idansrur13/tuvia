/*
 * מלאי קבלנים / סנכרון מול קבלן (פרק 6, פרק 8.1) —
 * צפייה בכל המלאי בזמן אמת + בקשת שריון. שריון שאושר נכנס
...
export default function SellerInventory({ loaderData }: Route.ComponentProps) {
  ...
  return (
    <div className='space-y-6'>
      <PageHeader title={tt('contractorInventory')} subtitle={tt('invSub')} />
